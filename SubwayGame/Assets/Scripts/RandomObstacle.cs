...
public class randomObstacle : MonoBehaviour
{
    ...
    private float spawnInterval = 4.7f; // Time interval to spawn a new object
    ...
    void SpawnNewObject()
    {
        ...
        Vector3 randomSpawnPosition = playerPosition + spawnDirection * 4f + randomSpawnOffset * 7f;

        // Instantiate the new object
        Debug.Log("New barrier ");
